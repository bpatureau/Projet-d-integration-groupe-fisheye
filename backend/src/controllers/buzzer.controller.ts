...
export const createBuzzer = asyncHandler(async (req: Request, res: Response) => {
  const buzzer = await buzzerService.create(req.body);
  res.status(201).json({ buzzer });
});

export const getAllBuzzers = asyncHandler(async (req: Request, res: Response) => {
...
export const updateBuzzer = asyncHandler(async (req: Request, res: Response) => {
  const buzzer = await buzzerService.update(req.params.id, req.body);
  res.json({ buzzer });
});

export const deleteBuzzer = asyncHandler(async (req: Request, res: Response) => {
