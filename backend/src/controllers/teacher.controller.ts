...
export const getTeacherLocations = asyncHandler(async (req: Request, res: Response) => {
  const locations = await teacherService.getLocations(req.params.id);
  res.json({ locations });
});

export const addTeacherToLocation = asyncHandler(async (req: Request, res: Response) => {
...
export const removeTeacherFromLocation = asyncHandler(async (req: Request, res: Response) => {
